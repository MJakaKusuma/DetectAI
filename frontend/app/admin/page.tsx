...
export default function AdminPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 space-y-10 min-h-[75vh]">
      ...
      {/* 1. TAB DASHBOARD */}
      {/* ========================================== */}
      {/* SESUDAH (Menjaga Tinggi Halaman Tetap Stabil Sejak Detik Pertama Dibuka) */}
      {activeTab === "dashboard" && (
        stats ? (
          ...
          // SKELETON LOADER BERUKURAN TETAP (MENCEGAH FOOTER MELOMPAT SAAT PROSES RETRIEVAL DATA)
